...
public class InformationSchemaService {
    ...
    public List<TableRelationInformation> getAllTableRelationInformation() {
        ...
        return informationSchemaRepository.getAllTableRelationInformation(applicationProperties.getTableToExport());
    }
    ...
    public List<ColumnInformation> getFullColumnInformationOfTable(final String tableName) {
        ...
        return informationSchemaRepository.getFullColumnInformationOfTable(applicationProperties.getTableToExport(), tableName);
    }
    ...
    public List<TableInformation> getAllTableInformation() {
        ...
        return informationSchemaRepository.getAllTableInformation(applicationProperties.getTableToExport());
    }

    @Cacheable("InformationSchemaService.getAllTableName")
    public List<String> getAllTableName() {
        log.debug("getAllTableName called");
        return informationSchemaRepository.getAllTableName(applicationProperties.getTableToExport());
    }
